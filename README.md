...
Изменение target URL уже созданной короткой ссылки не входит в MVP и остается Post-MVP функцией до появления backend/API-поддержки и дополнительных ограничений безопасности.
